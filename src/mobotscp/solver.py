...
class TSPparameters(rtsp.solver.SolverParameters):
  def __init__(self, Thome, qhome, phome, stack_offset):
    """
    ...
    * stack_offset: float
      Minimum distance between clusters in the stack-of-clusters model
    """
    self.Thome = Thome
    self.qhome = qhome
    self.phome = phome
