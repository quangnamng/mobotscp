...
if __name__ == "__main__":
  ...
  logger = logging.getLogger('drilling_task')
  ...
  acceleration_limits = (robot.GetDOFAccelerationLimits()*0.1).tolist()
  ...
  # > visualize floor points: uncomment 3 lines below
  # floor_validids_per_tar = output["floor_validids_per_tar"]
  # visual_floor = mtscp.utils.VisualizeFloor(targets, floor.floor_allpoints, floor_validids_per_tar, floor.floor_z)
  # visual_floor.visualize(env, [270, 280, 288])
  ...
  logger.info("Executed all trajectories in: real_exe_time = {} s".format(output["real_exe_time"]))
